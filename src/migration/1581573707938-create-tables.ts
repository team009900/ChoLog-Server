...
export class createTables1581573707938 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("CREATE TABLE `plants_database` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `distributionName` varchar(255) NOT NULL, `scientificName` varchar(255) NOT NULL, `englishName` varchar(255) NOT NULL, `detailImg` varchar(255) NOT NULL, `contentsNo` int NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `apiId` int UNSIGNED NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `api` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `provider` varchar(255) NOT NULL, `url` varchar(255) NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `family` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `familyName` varchar(255) NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `parameter` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `parameterName` varchar(255) NOT NULL, `type` tinyint NOT NULL DEFAULT 0, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `state` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `level` tinyint NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `parameterId` int UNSIGNED NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `diary` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `image` varchar(255) NULL, `note` varchar(255) NULL, `degree` int NULL, `weatherName` varchar(255) NULL, `humidity` int NULL, `finedust` int NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `plantId` int UNSIGNED NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `plant` (`id` int UNSIGNED NOT NULL AUTO_INCREMENT, `mainImage` varchar(255) NULL, `nickname` varchar(255) NOT NULL, `plantName` varchar(255) NOT NULL, `scientificName` varchar(255) NULL, `adoptionDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `deathDate` timestamp NULL, `memo` text NULL, `advice` text NULL, `openAllow` tinyint NOT NULL DEFAULT 1, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `userId` int NULL, `familyId` int UNSIGNED NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `username` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `image` varchar(255) NULL, `snsId` varchar(255) NULL, `provider` varchar(255) NOT NULL DEFAULT 'local', `commentAllow` tinyint NOT NULL DEFAULT 1, `open` tinyint NOT NULL DEFAULT 1, `reports` int NOT NULL DEFAULT 0, `banned` timestamp NULL DEFAULT null, `seed` int NOT NULL DEFAULT 0, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX `IDX_78a916df40e02a9deb1c4b75ed` (`username`), UNIQUE INDEX `IDX_e12875dfb3b1d92d7d7c5377e2` (`email`), UNIQUE INDEX `IDX_8434a0f43c344c75f5accc907b` (`snsId`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `blacklist` (`id` int NOT NULL AUTO_INCREMENT, `token` varchar(255) NOT NULL, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `userId` int NULL, UNIQUE INDEX `REL_53c1ab62c3e5875bc3ac474823` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("DROP INDEX `IDX_8434a0f43c344c75f5accc907b` ON `user`", undefined);
