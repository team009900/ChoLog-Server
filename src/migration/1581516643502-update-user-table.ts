...
export class updateUserTable1581516643502 implements MigrationInterface {
  name = "updateUserTable1581516643502";
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      "ALTER TABLE `user` CHANGE `provider` `provider` varchar(255) NOT NULL DEFAULT 'local'",
      undefined,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      "ALTER TABLE `user` CHANGE `provider` `provider` varchar(255) NOT NULL",
      undefined,
    );
    await queryRunner.query(
